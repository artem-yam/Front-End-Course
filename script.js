 ...
 */
 ...
 function isNegative(n) {
     var neg;
     if (!isNumber(n)) neg = 'Введенное значение - не число'
 ...
 */
 ...
 function isPositive(n) {
     var pos;
     if (!isNumber(n)) pos = 'Введенное значение - не число'
 ...
 */
 ...
 function factorial(n) {
     var fact;
     if (!isNumber(n)) fact = 'Введенное значение - не число'
     else if (n===0 || n==1) fact=1
     else if (n<0) fact = 'Нельзя найти факториал от отрицательного числа';
...
console.info('Number_Task_5');
 function isPrime(n) {
     var prime;
     if (!isNumber(n)) prime = 'Введенное значение - не число'
...
function canParseToNumber(str) {
    if (!isString(str)) return 'Введенное значение - не строка'
...
function removeSpecial(arr) {
    if (!isArray(arr)) return 'Введенное значение - не массив'
    else {
...
sortObjArray(library, 'title');
 for (var i=0;i<library.length;i++) console.log(library[i]);
